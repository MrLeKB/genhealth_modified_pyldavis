...
def _extract_data(sentiment,topic_model, corpus, dictionary, doc_topic_dists=None):
    import gensim
    ...
    return {'topic_sentiment':topic_sentiment,'topic_term_dists': topic_term_dists, 'doc_topic_dists': doc_topic_dists,
            'doc_lengths': doc_lengths, 'vocab': vocab, 'term_frequency': term_freqs}


def prepare(sentiment,topic_model, corpus, dictionary, doc_topic_dist=None, **kwargs):
    ...
    **kwargs :
    ...
    """
    opts = fp.merge(_extract_data(sentiment,topic_model, corpus, dictionary, doc_topic_dist), kwargs)
